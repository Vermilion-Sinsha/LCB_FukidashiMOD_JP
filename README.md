...
5. Launch the game, select "Custom Language," choose **SpeechDialogBoxesEN - NotherWael**, and restart the game.  
...
- When new story content or identities are added, please DISABLE the mod!!! and wait for an update in the release tab.
